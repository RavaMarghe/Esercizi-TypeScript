...
const nairaDescription = currencyNaira.describe();

console.log(nairaDescription)
...
const usDollarDescription = currencyUsDollar.describe();

console.log(usDollarDescription);
